...
<div class="container">
    ...
    <form action="?action=create-image" method="POST" enctype="multipart/form-data">
        ...
        <input class="form-control me-2" type="text" name="keyword" id="keywords" placeholder="Maison, voiture, Paris..." required>
